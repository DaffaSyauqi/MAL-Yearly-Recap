<template>
  <div
    class="top-0 left-0 z-1 absolute inset-0 flex flex-col justify-center items-center text-center w-full h-full"
  >
    <uiAnimatedContent
      :distance="50"
      direction="vertical"
    ...
    >
      <uiShinyText
        ...
        :disabled="false"
        :speed="2"
        class-name="mt-4 max-w-[24ch] font-bold text-[clamp(1rem,2vw,2.6rem)] text-center leading-[1.2] tracking-[-2px]"
      />

      <p
        class="mt-4 max-w-[24ch] font-bold text-[clamp(3rem,5vw,2.6rem)] text-white text-center leading-[1.2] tracking-[-2px]"
        :style="{
      ...
      <div class="flex items-center justify-center gap-4 mt-8">
        ...
        <a
          ref="githubBtn"
          href="https://github.com/DaffaSyauqi/MAL-Yearly-Recap"
          target="_blank"
